...
import {
  ...
  getLoading,
  getError
} from '@chaincodedev/decentraland-dapps/dist/modules/authorization/selectors'
import { FETCH_AUTHORIZATIONS_REQUEST } from '@chaincodedev/decentraland-dapps/dist/modules/authorization/actions'
...
const mapState = (state: RootState): MapStateProps => {
  ...
  // TODO: Change this to use ErrorCodes. Needs an overhaul on @chaincodedev/decentraland-dapps
  const hasError =
    !!error &&
